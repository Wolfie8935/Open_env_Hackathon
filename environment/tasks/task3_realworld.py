...
All files are visible at reset. Triage mode active.
"""
...
class Task3RealWorld(BaseTask):
    ...
    Triage mode: agents must report Critical findings (JWT Misconfiguration,
    SSRF, XXE Injection) before High before Medium.
    The primary chain objective is Complete Account Takeover
    ...
    description = (
        ...
        "Triage mode active: report Critical findings first."
    )
    difficulty = "hard"
    max_steps = 40
